...
@Component({
    ...
    template: `
                ...
                <aside-layout>
                    <aside-menu #left1 side="left" width="240px" is-backdrop="true" push-content="true">
                        <ul>
                            <li>Homepage</li>
                            <li>About</li>
                            <li>Contact</li>
                    ...
                    <aside-menu #right1 side="right" width="320px" is-backdrop="true" push-content="true">
                        <ul>
                            <li>Homepage</li>
                            <li>About</li>
                            <li>Contact</li>
                    ...
                    <div class="aside-content">
                        <div class="wrapper">
                            ...
                            <button type="button" (click)="left1.toggle()">Toggle Left Aside</button>
